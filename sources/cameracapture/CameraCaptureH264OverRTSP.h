#ifndef CAMERACAPTUREH264OVERRTSP_H
#define CAMERACAPTUREH264OVERRTSP_H
...
namespace vms {
    namespace cameracapture {
        class CameraCaptureH264OverRTSP : public ICameraCapture {
        private:
        ...
        public:
            CameraCaptureH264OverRTSP(const std::string & video_stream_address, const std::string & login, const std::string & password);
            ~CameraCaptureH264OverRTSP(){
                delete m_capture;
            }
